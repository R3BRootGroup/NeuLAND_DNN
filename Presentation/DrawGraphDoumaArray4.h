...
TCanvas* DrawGraphDoumaArray4(Int_t const Npads, Int_t const Nhor, Int_t const Nvert, TGraphErrors** const Raw, TString const Title[], TString const xlabel, TString const ylabel, Double_t const ScaleFactor, Int_t const Color, TString const PlotStyle = "AP")
{
