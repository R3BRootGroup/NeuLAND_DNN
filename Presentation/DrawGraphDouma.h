...
TCanvas* DrawGraphDouma(TGraphErrors* const Raw, TString const Title, TString const xlabel, TString const ylabel, Int_t const Color, Double_t const ScaleFactor)
{
