void NormalizationClass::DefaultNEBULANorms(Double_t const NewLeft, Double_t const NewRight)
{
    ...
    Double_t TimeNormalization_LeftBoundary = Inputs->GetInputDouble("NEBULA_DNNTextFile_TimeNormaliation_LeftBoundary","ns");
    Double_t TimeNormalization_RightBoundary = Inputs->GetInputDouble("NEBULA_DNNTextFile_TimeNormaliation_RightBoundary","ns");
    
    // Next, we will do the default time normalization that provides the user with a sensible option:
    Double_t ceff = Inputs->GetInputDouble("NEBULA_Digitizer_Effective_LightSpeed","cm/ns");
    Double_t TotalBarThickNess = Inputs->GetNEBULATotalPaddleThickness();
    Double_t Realistic_TimeInterval = 2.0*Inputs->GetInputDouble("NEBULA_Distance_BetweenModules","cm")/(ceff*BeamBeta);
    ...
    Double_t Old_Realistic_TimeInterval = Realistic_TimeInterval;
    ...
    X_Norm.Old_MeanShift = Inputs->GetInputDouble("NEBULA_center_x_position","cm");
    Double_t Xlength = 0.5*Inputs->GetInputDouble("NEBULA_Total_BarLength","cm");
    Double_t Xwidth = Inputs->GetNEBULATotalPaddleThickness()*0.5;
    Xwidth = Xwidth*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_Bars_in_OnePlane"));
    ...
    Y_Norm.Old_MeanShift = Inputs->GetInputDouble("NEBULA_center_y_position","cm");
    ...
    Double_t TotalDetectorThickness = ((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"))*2.0*TotalBarThickNess + Inputs->GetInputDouble("NEBULA_Distance_BetweenModules","cm");
    Z_Norm.Old_MeanShift = Inputs->GetInputDouble("NEBULA_front_z_position","cm") + 0.5*TotalDetectorThickness;
    ...
    // Total Energy Deposition (same as NeuLAND):
    ...
    // Total Number of Clusters (same as NeuLAND):
    ...
    BarPerPlane_Norm.Old_MeanShift = 0.5*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_Bars_in_OnePlane"));
    BarPerPlane_Norm.Old_ScaleFactor = 0.5*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_Bars_in_OnePlane"));
    ...
    TotalBarNorm.Old_MeanShift = ((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_Bars_in_OnePlane"))*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
    TotalBarNorm.Old_ScaleFactor = ((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_Bars_in_OnePlane"))*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
    ...
    PlaneNorm.Old_MeanShift = ((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
    PlaneNorm.Old_ScaleFactor = ((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
    ...
    dPlaneNorm.Old_MeanShift = 0.5*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
    dPlaneNorm.Old_ScaleFactor = 0.5*((Int_t) Inputs->GetInputInteger("NEBULA_Number_of_DoublePlaneModules"));
...
void NormalizationClass::BlankDefaultNEBULANorms(Double_t const NewLeft, Double_t const NewRight)
{
    TheNormParameters.clear();
