...
void GLAD_BuildGeometry()														// NOTE: Change by C. A. Douma! NOTE: Air <--> vacuum shift has been made to put GLAD to Vacuum!
{
  // =================================================================================
  ...
  Double_t X_position = Inputs->GetInputDouble("GLAD_center_x_position","cm");
  Double_t Y_position = Inputs->GetInputDouble("GLAD_center_y_position","cm");
  Double_t Z_position = Inputs->GetInputDouble("GLAD_center_z_position","cm");
  
  Double_t Rotation_X = Inputs->GetInputDouble("GLAD_x_rotation_angle","deg");
  Double_t Rotation_Y = Inputs->GetInputDouble("GLAD_y_rotation_angle","deg") + 90.0;
  Double_t Rotation_Z = Inputs->GetInputDouble("GLAD_z_rotation_angle","deg") - 90.0;
  
  // Define the file name:
  TString geoFileName = Inputs->GetInputString("TheOutputPath") + Inputs->GetInputString("GLAD_Geometry_FileName");
