...
void VacuumVessel_BuildGeometry()
{
  // Retrieve inputs:
  ...
  Double_t X_position = Inputs->GetInputDouble("Vacuum_Vessel_center_x_position","cm");
  Double_t Y_position = Inputs->GetInputDouble("Vacuum_Vessel_center_y_position","cm");
  Double_t Z_position = Inputs->GetInputDouble("Vacuum_Vessel_center_z_position","cm");
  
  Double_t Rotation_X = Inputs->GetInputDouble("Vacuum_Vessel_x_rotation_angle","deg");
  Double_t Rotation_Y = Inputs->GetInputDouble("Vacuum_Vessel_y_rotation_angle","deg");
  Double_t Rotation_Z = Inputs->GetInputDouble("Vacuum_Vessel_z_rotation_angle","deg");
  
  // Define the file name:
  TString geoFileName = Inputs->GetInputString("TheOutputPath") + Inputs->GetInputString("Vacuum_Vessel_Geometry_FileName");
