...
void CALIFA_BuildGeometry()
{
  ...
  Double_t X_position = Inputs->GetInputDouble("CALIFA_center_x_position","cm");
  Double_t Y_position = Inputs->GetInputDouble("CALIFA_center_y_position","cm");
  Double_t Z_position = Inputs->GetInputDouble("CALIFA_center_z_position","cm");
  
  Double_t Rotation_X = Inputs->GetInputDouble("CALIFA_x_rotation_angle","deg");
  Double_t Rotation_Y = Inputs->GetInputDouble("CALIFA_y_rotation_angle","deg");
  Double_t Rotation_Z = Inputs->GetInputDouble("CALIFA_z_rotation_angle","deg");
  
  // Define the file name:
  TString geoFileName = Inputs->GetInputString("TheOutputPath") + Inputs->GetInputString("CALIFA_Geometry_FileName");
