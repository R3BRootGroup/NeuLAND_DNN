...
void R3BScoreApplier::ReadNEBULACalibrationFile()
{
    ...
    { 
        ...
        if (MaxMultiplicity==(NLines-1))
        {
            ...
            // give some output:
            cout << "-I- R3BScoreApplier: Max. NEBULA Multiplicity = " << MaxMultiplicity << "\n"
        ...
        {
            cout << "### ERROR: R3BScoreApplier: The file holding the NEBULA calibration-cuts does not correspond to the current max. multiplicity in the Inputs-file!\n\n";
        }
    }
}

// Function to apply the calibration cuts inside the Exec-function:
Int_t R3BScoreApplier::ApplyNEBULACalibrationCuts()
{
    // Declare the answer:
    ...
    if (UseNEBULACalibrationCuts==kTRUE)
    {
        ...
        else
        {
            ...
            {
                std::cout << "### R3BScoreApplier: SERIOUS ERROR IN APPLYING THE NEBULA CUTS!!!\n\n";
            }
        }
