...
if __name__ == "__main__":
   ...
   # Set the parameters:
    ...
    TheNetworkName = ThisOutputPath + 'Step2Network_NEBULA_Mult' + TheLabelStr + '_Final.h5' # ATTENTION: NEBULA!
    ...
    if (SetParameters.NetworkType=='ScoringPlus_OneCluster'):
        ...
        f= open(SetParameters.OutputPath+"/Predicted_NEBULA_Clusters_Mult" + TheLabelStr + ".txt","w+") # ATTENTION: NEBULA!
        ...
        for kBatch in range(0,SetParameters.nBatches):
            ...
            if ((InputData.shape[0]<=SetParameters.BatchSize) and 
                ...
                # Give a warning:
                print('NEBULA Netwok update from batch '+str(kBatch+1)+' from '+str(SetParameters.nBatches)+ ' was skipped because the matrix dimensions were incorrect!') # ATTENTION: NEBULA!
