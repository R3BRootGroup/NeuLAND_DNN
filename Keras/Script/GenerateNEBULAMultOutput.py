...
if __name__ == "__main__":
    ...
    TheNetworkName = ThisOutputPath + 'TheNEBULAMultNetwork' + TheEpochStr + '.h5' # ATTENTION: NEBULA!
    ...
    if ((SetParameters.NetworkType=='IO_Signals_ElenaHoemann') or
        ...
        f= open(SetParameters.OutputPath+"/Predicted_NEBULA_Multiplicities.txt","w+") # ATTENTION: NEBULA!
